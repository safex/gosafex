...
func TestTxCreate(t *testing.T) {
	...
	fmt.Println(addr.ViewKey)
	fmt.Println(addr.SpendKey)
	var extra []byte
	ptxs := wallet.TxCreateCash([]DestinationEntry{DestinationEntry{300000000000, 0, *addr, false, false}}, 2, 0, 1, extra, true)
